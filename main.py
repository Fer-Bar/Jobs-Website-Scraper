...
# Le preguntamos al usuario las tecnologías con las que no este 
# familiarizado para filtrar las busquedas
unfamiliar_skills = input('Put some skills that you are not familiar with: ').split(' ')
